...
const PasskeyManager = ({ getProfile }) => {
  ...
  const fetchPasskeys = async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/auth/passkey`,
  ...
  const handlePasskeyRegister = async () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "Failed to register passkey",
      );
    } finally {
  ...
  const handleDeletePasskey = async () => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/auth/passkey/${deletePasskeyId}`,
        { withCredentials: true },
      );
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Enter a nickname for your new passkey to help you identify it
                later.
              </DialogDescription>
            </DialogHeader>
              ...
              <AlertDialogDescription>
                ...
                {passkeys.length === 1 && (
                  <p className="mt-2 text-red-500">
                    Warning: This is your last passkey. Deleting it will disable
