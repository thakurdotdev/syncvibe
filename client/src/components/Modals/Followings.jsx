...
import { Dialog, DialogTrigger, DialogHeader, DialogContent, DialogClose } from "../ui/dialog"
          ...
          {following.map((follow) => (
            <DialogTrigger asChild>
              ...
              >
                <Avatar>
                  <AvatarImage
                    src={getProfileCloudinaryUrl(follow?.followingDetail?.profilepic)}
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-neutral-500">@{follow?.followingDetail?.username}</p>
                </div>
              </div>
            </DialogTrigger>
          ))}
