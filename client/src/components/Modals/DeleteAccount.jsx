            ...
            <DialogDescription>
              {!otpSent ? (
                <p className="text-center mt-5">
                  Are you sure you want to delete your account? This action cannot be undone. An OTP
                  will be sent to your registered email for verification.
                </p>
              ) : (
                <p className="text-center mt-5">
                  Enter the 6-digit OTP sent to your registered email to confirm account deletion.
                </p>
              )}
            </DialogDescription>
          </DialogHeader>
