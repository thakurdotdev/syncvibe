                ...
                <div className='space-y-6'>
                  ...
                  <div className='flex gap-6'>
                    <div className='text-center'>
                      ...
                      <p className='text-sm text-muted-foreground'>{post.likesCount || 0} likes</p>
                    </div>
                    <div className='text-center'>
                  ...
                  <div>
                    ...
                    <p className='text-muted-foreground leading-relaxed'>{post.title}</p>
                  </div>

                  {/* Image Gallery */}
                  {post.images?.length > 1 && (
                    <div>
                      <h4 className='font-semibold mb-3 text-foreground'>All Images</h4>
      ...
      <div className='min-h-screen bg-background flex items-center justify-center p-6'>
        ...
        >
          ...
          <p className='text-muted-foreground mb-8 leading-relaxed text-lg'>
            Start sharing your moments with the world. Your posts will appear here in a beautiful
            gallery.
          </p>
          <Link to='/feed'>
            <Button
  ...
  if (isLoading) {
    return (
      <div className='min-h-screen bg-background flex flex-col items-center justify-center'>
        ...
        <h3 className='text-xl font-semibold text-foreground mb-2'>Loading your posts...</h3>
      ...
      <div className='min-h-screen bg-background'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          ...
          <div className='flex flex-row sm:items-center justify-between gap-4 mb-12'>
            <h1 className='text-2xl font-bold text-foreground mb-3'>My Posts</h1>
            ...
            {Object.entries(groupedPosts).map(([monthKey, monthPosts]) => (
              <div key={monthKey} className='space-y-6'>
                ...
                <div className='flex items-center gap-4'>
                  <h2 className='text-xl sm:text-2xl font-bold text-foreground'>{monthKey}</h2>
                ...
                >
                  {monthPosts.map((post, index) => (
                    <PostCard key={post.postid} post={post} index={index} size={'normal'} />
                  ))}
                </div>
              </div>
            ))}
