export default function Android({
  ...
  // For preserveAspectRatio attribute - determines how to scale the image
  // Use "slice" to fill the entire area (may crop), or "meet" to fit entirely (may show margins)
  const preserveAspect = imageRatio > screenRatio ? 'xMidYMid slice' : 'xMidYMid slice';
