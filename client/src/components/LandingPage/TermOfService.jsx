      ...
      <div className="max-w-4xl mx-auto px-6 py-14 lg:px-8 shadow-lg rounded-lg">
        ...
        <main className="space-y-6  leading-relaxed">
          <section>
            ...
            <p className="mt-2">
              By accessing or using the SyncVibe website, you agree to comply
          ...
          <section>
            ...
            <p className="mt-2">
              You must be at least 13 years old to use SyncVibe. By using the
              website, you confirm that you meet this age requirement.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              ...
              <li>
                Engage in activities that disrupt or interfere with the
          ...
          <section>
            ...
            <p className="mt-2">
              All content, trademarks, and logos on SyncVibe are the property of
              their respective owners. You agree not to use or distribute any
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              SyncVibe at our sole discretion, without prior notice, for
          ...
          <section>
            ...
            <p className="mt-2">
              SyncVibe is provided "as is" without warranties of any kind. We
              are not liable for any damages or losses resulting from your use
              of the website.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              disputes will be resolved exclusively in the courts of [Your
              Location].
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              use of SyncVibe after changes are posted constitutes acceptance of
              the revised terms.
            </p>
          </section>
