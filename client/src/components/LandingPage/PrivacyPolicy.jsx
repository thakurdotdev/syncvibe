      ...
      <div className="max-w-4xl mx-auto px-6 py-14 lg:px-8 shadow-lg rounded-lg">
        ...
        <main className="space-y-6  leading-relaxed">
          <section>
            ...
            <p className="mt-2">
              Welcome to SyncVibe! Your privacy is critically important to us.
              This Privacy Policy explains how we collect, use, and safeguard
              your information when you use our website. By using SyncVibe, you
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li>
                ...
                and any other information you provide during registration.
              </li>
              <li>
                <strong>Usage Data:</strong> Information about how you interact
                with our website, such as pages visited and features used.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              others. We may share your data with trusted partners to help us
              provide and improve our services, subject to confidentiality
              agreements.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              method of transmission or storage is 100% secure. Please contact
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              will be posted on this page, and your continued use of SyncVibe
