    ...
    <div className='mx-auto'>
            ...
            <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
              ...
              {currentGroup && (
                <div className='flex gap-4'>
                  ...
                  >
                    <p className='text-sm font-medium'>Group ID: {currentGroup?.id}</p>
                    <Button
                      onClick={handleCopy}
              ...
              {!currentGroup ? (
                ...
                >
                  <div className='text-center space-y-4'>
                    <h2 className='text-2xl font-bold'>Welcome to Group Music Player</h2>
                    <p className='text-muted-foreground max-w-md mx-auto'>
                      Create a new group or join an existing one to start listening to music
                  ...
                  <div className='flex justify-center'>
                    ...
                    >
                      <Plus className='mr-2 h-5 w-5 inline-block' /> Create or Join a Group
                    </motion.button>
                  </div>
                </motion.div>
              ) : (
                    ...
                    {currentSong ? (
                      <div className='flex flex-col md:flex-row gap-8'>
                        ...
                        <div className='flex-1 space-y-6'>
                          <div>
                            <h3 className='text-2xl font-medium mb-2'>{currentSong.name}</h3>
                      ...
                      >
                        ...
                        <p className='text-2xl font-medium mb-2'>No song playing</p>
            ...
            <Tabs defaultValue='create' className='w-full'>
              ...
              <TabsContent value='create' className='space-y-4 mt-4'>
                <Input
                  ...
                  className='rounded-full'
                />
                <Button onClick={() => createGroup(newGroupName)} className='w-full rounded-full'>
                  Create Group
                </Button>
              </TabsContent>
              <TabsContent value='join' className='space-y-4 mt-4'>
                <Input
                  ...
                  className='rounded-full'
                />
                <Button onClick={() => joinGroup(groupId)} className='w-full rounded-full'>
                  Join Group
                </Button>
              </TabsContent>
            </Tabs>
      ...
      {currentGroup && currentGroup.qrCode && (
        <Dialog open={isQrCodeOpen} onOpenChange={setQrCodeOpen}>
          <DialogContent className='sm:max-w-[425px]'>
            <DialogHeader>
              <DialogTitle className='text-xl font-bold text-center'>Group QR Code</DialogTitle>
            </DialogHeader>
            <div className='flex flex-col items-center space-y-4 p-4'>
              ...
              <div className='flex gap-2'>
                <Button onClick={handleCopy} variant='default' className='rounded-full w-full'>
                  Copy Group ID
                </Button>
              </div>
            </div>
